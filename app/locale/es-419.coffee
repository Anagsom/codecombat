module.exports = nativeDescription: "Español (América Latina)", englishDescription: "Spanish (Latin America)", translation:
  ...
  nav:
    ...
    help_pref: "¿Necesitas ayuda? ¡Envíanos un correo electrónico!"
    help_suff: "Te contactaremos pronto"
  ...
  diplomat_suggestion:
    ...
    pitch_body: "Desarrollamos CodeCombat en inglés, pero ya tenemos jugadores de todo el mundo. Muchos de ellos quieren jugar en español pero no hablan inglés, así que si puedes hablar ambos, por favor considera registrarte para ser un Diplomático y ayudar a traducir tanto el sitio de CodeCombat como todos los niveles al español."
...
#    get_course_for_class: "Assign Game Development and more to your classes!"
    request_licenses: "Contacta a nuestros especialistas en escuelas para obtener detalles."
    ...
    brain_pop_challenge: "¡Desafíate a jugar de nuevo usando otro lenguaje de programación!"
    replay: "Repetir"
    back_to_classroom: "Volver al aula"
    teacher_button: "Para maestros"
    get_more_codecombat: "Obtén más CodeCombat"
  ...
  signup:
    ...
    teacher_email_announcements: "¡Mantenerme informado sobre nuevos recursos, curriculum, y cursos para maestros!"
    ...
    birthday: "Cumpleaños"
    parent_email_blurb: "¡Sabemos que no puedes esperar para aprender programación &mdash; a nosotros nos emociona también! Tus padres recibirán un email con instrucciones adicionales para crear tu cuenta. Email {{email_link}} si tienes alguna pregunta."
    classroom_not_found: "No hay clases con este Código de clase. Revisa tu redacción o pide ayuda a tu maestro."
    ...
    teacher_type_1: "¡Enseña a programar con CodeCombat!"
    teacher_type_2: "Establece tu clase"
    teacher_type_3: "Acceder a guías del curso"
    teacher_type_4: "Ver progreso de estudiantes"
    signup_as_teacher: "Iniciar sesión como Maestro"
    student_type_1: "¡Aprende a programar jugando un atractivo y emocionante juego!"
    student_type_2: "Jugar con tu clase"
    student_type_3: "Competir en arenas"
    student_type_4: "¡Elige tu héroe!"
    student_type_5: "¡Ten listo tu Código de clase!"
    signup_as_student: "Iniciar sesión como Estudiante"
    individuals_or_parents: "Individuos y padres"
    individual_type: "Para jugadores que están aprendiendo a programar fuera de una clase. Los padres deberán registrar su cuenta aquí."
    ...
    ask_teacher_1: "Pregunta a tu maestro por el Código de clase."
    ask_teacher_2: "¿No eres parte de una clase? Crea una "
    ask_teacher_3: "Cuenta individual"
    ask_teacher_4: " a cambio."
    about_to_join: "Estás a punto de unirte:"
    enter_parent_email: "Ingresa el email de tu padre o madre:"
    parent_email_error: "Algo salió mal al intentar envial el correo. Revisa la dirección de email e intenta de nuevo."
    parent_email_sent: "Enviamos un email con  We’ve sent an email with further instructions on how to create an account. Ask your parent to check their inbox."
